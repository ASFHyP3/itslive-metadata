...
def ingest_stac():
    ...
    parser.add_argument('-i', '--item', required=True, help='Path to a single ITS_LIVE STAC item file')
    ...
    parser.add_argument(
        '-r', '--reload-collection', action='store_true', help='If present will reload/update the collection'
    )
